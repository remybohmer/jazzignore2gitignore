// This class has been taken from the 'https://github.com/rtcTo/rtc2gitcli' project.
...
public class JazzignoreTranslator {
	...
	public static List<String> toGitignore(File jazzignore) {
		...
		try {
			...
			List<String> jazzignoreLines = Files.readAllLines(jazzignore.toPath(), Charset.defaultCharset());
			String lineForRegex = "";
